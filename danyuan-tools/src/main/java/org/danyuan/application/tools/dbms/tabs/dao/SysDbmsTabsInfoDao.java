...
/**
 * 文件名 ： SysTableDao.java 包 名 ： tk.ainiyue.danyuan.application.dbm.table.dao 描 述
 * ： TODO(用一句话描述该文件做什么) 机能名称： 技能ID ： 作 者 ： wang 时 间 ： 2017年8月3日 下午3:54:48 版 本 ：
 * V1.0
 */
...
public interface SysDbmsTabsInfoDao extends BaseDao<SysDbmsTabsInfo> {
	...
	/**
	 * 方法名： findAllByUserIndex 功 能： TODO(这里用一句话描述这个方法的作用) 参 数： @param userindex
	 * 参 数： @return 返 回： List<SysZhcxTab> 作 者 ： Administrator @throws
	 */
	...
	/**
	 * 方法名： findAllByTypeUuid 功 能： TODO(这里用一句话描述这个方法的作用) 参 数： @param typeUuid 参
	 * 数： @return 返 回： List<SysZhcxTab> 作 者 ： Administrator @throws
	 */
	...
	/**
	 * 方法名： findByAddrUuidIsNotNullAndUpdateTimeGreaterThan 功 能：
	 * TODO(这里用一句话描述这个方法的作用) 参 数： @param i 参 数： @return 返 回：
	 * com.shumeng.application.common.config.list<SysZhcxTab> 作 者 ：
	...
	/**
	 * @方法名 change @功能 TODO(这里用一句话描述这个方法的作用) @参数 @param tabsName @参数 @param
	 * tabsDesc @参数 @param typeUuid @参数 @param jdbcUuid @参数 @param uuid @返回
