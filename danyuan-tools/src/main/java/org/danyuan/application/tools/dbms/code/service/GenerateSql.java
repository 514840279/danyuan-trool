...
public class GenerateSql {
	 ...
	 *            colsInfos @参数 @param username @参数 @param pathString @返回
	...
	/**
	 * @方法名 generateConfig @功能 TODO(这里用一句话描述这个方法的作用) @参数 @param
	 *      sysDbmsGenerateCodeInfo @参数 @param tabsInfo @参数 @param
	 *      colsInfos @参数 @param username @参数 @param pathtempString @返回
	 *      void @author Administrator @throws
	 */
