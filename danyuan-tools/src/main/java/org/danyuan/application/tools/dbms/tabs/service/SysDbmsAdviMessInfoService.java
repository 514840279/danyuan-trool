...
/**
 * 文件名 ： SysDbmsAdviMessInfoService.java 包 名 ：
 * com.shumeng.application.application.zhcx.service 描 述 ： TODO(用一句话描述该文件做什么)
 * 机能名称： 技能ID ： 作 者 ： Administrator 时 间 ： 2018年4月27日 下午5:27:33 版 本 ： V1.0
 */
@Service
public class SysDbmsAdviMessInfoService extends BaseServiceImpl<SysDbmsAdviMessInfo>
	 ...
	 * 参 考 ： @see
	 * com.shumeng.application.common.base.BaseService#findOne(java.lang.Object)
	 * 作 者 ： Administrator
	 */
	 ...
	 * 参 考 ： @see
	 * com.shumeng.application.common.base.BaseService#findAll(java.lang.Object)
	 * 作 者 ： Administrator
	 */
