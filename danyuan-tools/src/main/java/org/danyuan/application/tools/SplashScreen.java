package org.danyuan.application.tools;
...
/**
 * A default standard splash pane implementation Subclass it and override it's methods to customize with your own behavior. Be aware that you can not use Spring features here yet.
 *
 * @author Felix Roske
 * @author Andreas Jay
 */
public class SplashScreen {
	...
	private static String DEFAULT_IMAGE = "/static/dist/imgs/uugai_94x194.png";
