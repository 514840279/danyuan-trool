...
/**
 * 文件名 ： SysColumnDao.java 包 名 ： tk.ainiyue.danyuan.application.dbm.column.dao 描
 * 述 ： TODO(用一句话描述该文件做什么) 机能名称： 技能ID ： 作 者 ： wang 时 间 ： 2017年8月3日 下午3:51:45 版 本
 * ： V1.0
 */
...
public interface SysDbmsTabsColsInfoDao extends BaseDao<SysDbmsTabsColsInfo> {
	...
	/**
	 * 方法名： deleteByTabsUuid 功 能： TODO(这里用一句话描述这个方法的作用) 参 数： @param cols 返 回：
