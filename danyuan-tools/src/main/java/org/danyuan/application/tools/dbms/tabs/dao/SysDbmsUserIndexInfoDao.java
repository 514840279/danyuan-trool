...
/**
 * 文件名 ： SysDicUserIndexCodeDao.java 包 名 ： com.shumeng.application.zhcx.dao 描 述
...
public interface SysDbmsUserIndexInfoDao extends BaseDao<SysDbmsUserIndexInfo> {
	...
	/**
	 * 方法名： findAllByDeleteFlag 功 能： TODO(这里用一句话描述这个方法的作用) 参 数： @return 返 回：
	...
	/**
	 * @方法名 findAllByChart @功能 TODO(这里用一句话描述这个方法的作用) @参数 @return @返回
	 * List<SysDbmsUserIndexInfo> @author Administrator @throws
	 */
